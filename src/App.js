...
import { DatePicker, Button, Card, Typography, Space, Row, Col } from "antd";
...
<div style={{ maxWidth: '80%', margin: "auto", padding: 20 }}>
      <Card bordered>
        <Row gutter={16} align="middle">
          ...
          <Col span={12}>
           <Card bordered>
            <Title level={5}>Selecciona una fecha:</Title>
            <DatePicker
              ...
              format="DD/MM/YYYY"
            />
            {/* agregar input de cantidad y descripcion */}
            </Card>
          </Col>
        ...
        {selectedDate && selectedTime && (
          <Card style={{ marginTop: 20, textAlign: "center" }}>
            ...
            <p>{selectedDate.format("DD/MM/YYYY")} a las {selectedTime}</p>
